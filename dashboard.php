...
<div class="container">
    ...
    <form method="POST" action="dashboard.php">
        ...
        <select name="backend_id" id="backend_id">
            ...
            <option value="<?php echo htmlspecialchars($server['id']); ?>" <?php echo ($server['id'] === $selected_backend_id) ? 'selected' : ''; ?>>
                <?php echo htmlspecialchars($server['name']); ?> (<?php echo htmlspecialchars($server['url']); ?>)
            </option>
            <?php endforeach; ?>
        </select>
    ...
    <h3>当前后端: <?php echo htmlspecialchars($selected_backend['name']); ?></h3>
